...
namespace Web.Api.Core.Middleware
{
    ...
    public class ReverseProxyMiddleware
    {
        ...
        private List<ReverseProxyConfiguration> _reverseProxyConfigurations = new List<ReverseProxyConfiguration>();

        public ReverseProxyMiddleware(RequestDelegate nextMiddleware, IOptions<ReverseProxySettings> reverseProxySettings)
        {
